...
class SerializerContextBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateFromRequest()
    {
        ...
        $request = new Request([], [], ['_api_resource_class' => 'Foo', '_api_item_operation_name' => 'get', '_api_format' => 'xml', '_api_mime_type' => 'text/xml']);
        $expected = ['bar' => 'baz', 'item_operation_name' => 'get',  'resource_class' => 'Foo', 'request_uri' => '', 'allow_update' => false];
        ...
        $expected = ['bar' => 'baz', 'collection_operation_name' => 'post',  'resource_class' => 'Foo', 'request_uri' => '', 'allow_update' => false];
        $this->assertEquals($expected, $this->builder->createFromRequest($request, false));
        ...
        $expected = ['bar' => 'baz', 'collection_operation_name' => 'put', 'resource_class' => 'Foo', 'request_uri' => '', 'allow_update' => true];
        $this->assertEquals($expected, $this->builder->createFromRequest($request, false));
    }
