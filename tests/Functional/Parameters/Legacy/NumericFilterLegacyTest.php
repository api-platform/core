...
/**
 * Regression coverage for the deprecated NumericFilter. The canonical equivalent
 * (ExactFilter + numeric nativeType) is covered by
 * ApiPlatform\Tests\Functional\Parameters\NumericFilterTest.
 * Remove together with the deprecated filter in 6.0.
 */
#[Group('legacy')]
final class NumericFilterLegacyTest extends ApiTestCase
{
    ...
    {
        yield 'quantity_int_equal' => ['/legacy_filtered_numeric_parameters?quantity=10', 1];
        yield 'ratio_float_equal' => ['/legacy_filtered_numeric_parameters?ratio=1.0', 2];
        yield 'amount_alias_int_equal' => ['/legacy_filtered_numeric_parameters?amount=20', 2];
    }
    ...
    {
        yield 'quantity_int_null_value' => ['/legacy_filtered_numeric_parameters?quantity=null', 4];
        yield 'quantity_int_empty_value' => ['/legacy_filtered_numeric_parameters?quantity=', 4];
        yield 'ratio_float_null_value' => ['/legacy_filtered_numeric_parameters?ratio=null', 4];
        yield 'ratio_float_empty_value' => ['/legacy_filtered_numeric_parameters?ratio=', 4];
        yield 'amount_alias_int_null_value' => ['/legacy_filtered_numeric_parameters?amount=null', 4];
        yield 'amount_alias_int_empty_value' => ['/legacy_filtered_numeric_parameters?amount=', 4];
    }
