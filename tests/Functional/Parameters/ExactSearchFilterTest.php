...
final class ExactSearchFilterTest extends ApiTestCase
{
    ...
    {
        yield 'filter_by_author_exact_1_url' => [
            '/dummy_book_exacts?dummyAuthorExact=/dummy_author_exacts/1',
            2,
            ['Book 1', 'Book 2'],
        ];

        yield 'filter_by_author_exact_2_url' => [
            '/dummy_book_exacts?dummyAuthorExact=/dummy_author_exacts/2',
            1,
            ['Book 3'],
        ];
