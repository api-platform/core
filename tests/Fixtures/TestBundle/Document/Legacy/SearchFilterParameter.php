 ...
 * ODMSearchFilterValueTransformer / ODMSearchTextAndDateFilter wrappers and the #[ApiFilter]
 * attribute aliases referenced by QueryParameter. Canonical scalar/search coverage lives on
