...
#[ApiResource(
    shortName: 'JsonApiAbsoluteUrlRelationDummy',
    formats: ['jsonapi' => ['application/vnd.api+json']],
    urlGenerationStrategy: UrlGeneratorInterface::ABS_URL,
    operations: [
        new Get(
            uriTemplate: '/jsonapi_absolute_url_relation_dummies/{id}',
            uriVariables: ['id'],
            provider: [self::class, 'provide'],
        ),
        new Post(
            uriTemplate: '/jsonapi_absolute_url_relation_dummies',
...
class AbsoluteUrlRelationDummy
{
    ...
    /** @var AbsoluteUrlDummy[] */
    public array $absoluteUrlDummies = [];
