...
#[ApiResource(
    shortName: 'HalUriTemplateCar',
    operations: [
        new GetCollection(
            uriTemplate: '/hal_uri_template_cars',
            provider: [self::class, 'provideCollection'],
        ),
        new Get(
            uriTemplate: '/hal_uri_template_cars/{id}',
            uriVariables: ['id'],
        ...
        new GetCollection(
            uriTemplate: '/hal_uri_template_brands/renault/cars',
            itemUriTemplate: '/hal_uri_template_brands/renault/cars/{id}',
            provider: [self::class, 'provideCollection'],
        ),
        new Post(
            uriTemplate: '/hal_uri_template_brands/renault/cars',
        ...
        new Get(
            uriTemplate: '/hal_uri_template_brands/renault/cars/{id}',
            uriVariables: ['id'],
            provider: [self::class, 'provide'],
        ),
    ],
