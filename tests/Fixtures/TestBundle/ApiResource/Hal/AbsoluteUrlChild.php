...
#[ApiResource(
    shortName: 'HalAbsoluteUrlChild',
    urlGenerationStrategy: UrlGeneratorInterface::ABS_URL,
    operations: [
        new GetCollection(
            uriTemplate: '/hal_absolute_url_children',
            provider: [self::class, 'provideCollection'],
        ),
        new Get(
            uriTemplate: '/hal_absolute_url_children/{id}',
            uriVariables: ['id'],
        ...
        new GetCollection(
            uriTemplate: '/hal_absolute_url_parents/{parentId}/children',
            uriVariables: [
