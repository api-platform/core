...
class ApiPlatformExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function getContainerBuilderProphecy()
    {
        ...
        $parameters = [
            ...
            'api_platform.oauth2.enabled' => false,
            'api_platform.oauth2.clientId' => '',
            'api_platform.oauth2.clientSecret' => '',
            'api_platform.oauth2.type' => 'oauth2',
            'api_platform.oauth2.flow' => 'application',
            'api_platform.oauth2.tokenUrl' => '/oauth/v2/token',
            'api_platform.oauth2.authorizationUrl' => '/oauth/v2/auth',
            'api_platform.oauth2.scopes' => [],
        ...
        $definitions = [
            ...
            'api_platform.jsonld.normalizer.item',
            'api_platform.oauth2.oauth2_config',
