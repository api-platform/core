...
namespace ApiPlatform\Tests\Bridge\Doctrine\Odm\State;

use ApiPlatform\Bridge\Doctrine\Odm\State\ItemProvider;
...
class ItemProviderTest extends TestCase
{
    ...
    public function testAggregationResultExtension()
    {
        ...
        $dataProvider = new ItemProvider($resourceMetadataFactory, $managerRegistry, [$extensionProphecy->reveal()]);
