...
class ItemDataProviderTest extends TestCase
{
    ...
    {
        $context = ['foo' => 'bar', 'fetch_data' => true, ChainIdentifierNormalizer::HAS_IDENTIFIER_NORMALIZER => true];
    ...
    public function testCannotCreateQueryBuilder()
    {
        ...
        (new ItemDataProvider($managerRegistryProphecy->reveal(), $propertyNameCollectionFactory, $propertyMetadataFactory, [$extensionProphecy->reveal()]))->getItem(Dummy::class, 'foo', null, [ChainIdentifierNormalizer::HAS_IDENTIFIER_NORMALIZER => true]);
    }
