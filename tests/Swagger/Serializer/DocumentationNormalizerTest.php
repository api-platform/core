...
class DocumentationNormalizerTest extends TestCase
{
    ...
    public function testNormalize()
    {
        ...
        $propertyNameCollectionFactoryProphecy->create(Dummy::class, [])->shouldBeCalled()->willReturn(new PropertyNameCollection(['id', 'name', 'title']));
        ...
        $propertyMetadataFactoryProphecy->create(Dummy::class, 'title')->shouldBeCalled()->willReturn(new PropertyMetadata(new Type(Type::BUILTIN_TYPE_STRING), 'This is a title.', true, false, true, true, false, false, null, null, [], null, true));
