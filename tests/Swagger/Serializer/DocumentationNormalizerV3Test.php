...
class DocumentationNormalizerV3Test extends TestCase
{
    ...
    public function testNormalizeWithNestedNormalizationGroups(): void
    {
        ...
        $formats = self::OPERATION_FORMATS;
        $formats['output_formats']['json-api'] = ['application/vnd.api+json'];
        ...
        $dummyMetadata = new ResourceMetadata(
            ...
            'http://schema.example.com/Dummy',
            [
                'get' => ['method' => 'GET'] + $formats,
                'put' => ['method' => 'PUT', 'normalization_context' => [AbstractNormalizer::GROUPS => $groups]] + $formats,
            ],
            [
                'get' => ['method' => 'GET'] + $formats,
                'post' => ['method' => 'POST'] + $formats,
            ]
        );
