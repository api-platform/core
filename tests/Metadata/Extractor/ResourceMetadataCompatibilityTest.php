...
final class ResourceMetadataCompatibilityTest extends TestCase
{
    ...
    private const FIXTURES = [
        ...
        [
            ...
            'securityPreRead' => 'is_granted(\'ROLE_OWNER\')',
            'securityPreReadMessage' => 'Sorry, you must the owner of this resource to access it.',
            ...
            'graphQlOperations' => [
                'mutations' => [
                    [
                        ...
                        'securityPreRead' => 'is_granted(\'ROLE_CUSTOM_ADMIN\')',
                        'securityPreReadMessage' => 'Sorry, you must an admin to access this collection.',
                        'read' => true,
                        'deserialize' => false,
                        'validate' => false,
                        'write' => false,
