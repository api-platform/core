...
use ApiPlatform\Tests\Fixtures\DummyObjectWithoutProperty;
...
class PropertyInfoPropertyNameCollectionFactoryTest extends TestCase
{
    ...
    public function testCreateMethodReturnsProperPropertyNameCollectionForObjectWithIgnoredProperties(): void
    {
        ...
        if (method_exists(self::class, 'assertObjectHasProperty')) {
            self::assertObjectHasProperty('ignored', new DummyIgnoreProperty());
        } else {
