...
class SchemaFactoryTest extends TestCase
{
    ...
    public function testBuildSchema(): void
    {
        ...
        $this->assertEquals(urlencode(Dummy::class.':jsonld'), $resultSchema->getRootDefinitionKey());
    }
    ...
    public function testCustomFormatBuildSchema(): void
    {
        ...
        $this->assertTrue($resultSchema->isDefined());
        $this->assertEquals(urlencode(Dummy::class), $resultSchema->getRootDefinitionKey());
    }
    ...
    public function testHasRootDefinitionKeyBuildSchema(): void
    {
        ...
        $this->assertEquals(urlencode(Dummy::class.':jsonld'), $rootDefinitionKey);
