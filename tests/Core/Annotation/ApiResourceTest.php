...
class ApiResourceTest extends TestCase
{
    ...
    public function testConstruct()
    {
        $resource = new ApiResource([
            ...
            'securityPreRead' => 'is_granted("ROLE_FOOBAR")',
            'securityPreReadMessage' => 'You are not foobar.',
        ...
        $this->assertEquals([
            ...
            'security_pre_read' => 'is_granted("ROLE_FOOBAR")',
            'security_pre_read_message' => 'You are not foobar.',
