...
class AnnotationSubresourceMetadataFactoryTest extends TestCase
{
    ...
    public function testCreatePropertyUnknownType()
    {
        ...
        $this->expectExceptionMessage('Property "relatedDummies" on resource "ApiPlatform\\Tests\\Fixtures\\TestBundle\\Entity\\Dummy" is declared as a subresource, but its type could not be determined.');
