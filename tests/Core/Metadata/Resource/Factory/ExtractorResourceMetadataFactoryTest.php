...
class ExtractorResourceMetadataFactoryTest extends FileConfigurationMetadataFactoryProvider
{
    ...
    public function testXmlDoesNotExistMetadataFactory()
    {
        ...
        $this->expectExceptionMessage('Resource "ApiPlatform\\Tests\\Fixtures\\TestBundle\\Entity\\ThisDoesNotExist" not found.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageMatches('/"ApiPlatform\\\\Tests\\\\Fixtures\\\\TestBundle\\\\Entity\\\\Dummy" setting is expected to be null or an array, string given in ".+\\/Fixtures\\/FileConfigurations\\/bad_declaration\\.yml"\\./');
