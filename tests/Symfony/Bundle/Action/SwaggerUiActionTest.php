...
namespace ApiPlatform\Tests\Symfony\Bundle\Action;
...
class SwaggerUiActionTest extends TestCase
{
    ...
    {
        $this->expectDeprecation('The use of "ApiPlatform\Core\Bridge\Symfony\Bundle\Action\SwaggerUiAction" is deprecated since API Platform 2.6, use "ApiPlatform\Symfony\Bundle\SwaggerUi\SwaggerUiAction" instead.');
