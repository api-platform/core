...
class GraphQlTypePassTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $typeLocatorDefinitionProphecy->addArgument(Argument::that(static fn (array $arg): bool => !isset($arg['foo']) && isset($arg['my_id']) && $arg['my_id'] instanceof Reference))->willReturn($typeLocatorDefinitionProphecy->reveal())->shouldBeCalled();
    ...
    public function testIdNotExist(): void
    {
        ...
        $typeLocatorDefinitionProphecy = $this->prophesize(Definition::class);
        $typeLocatorDefinitionProphecy->addArgument(Argument::that(static fn (array $arg): bool => !isset($arg['foo']) && isset($arg['bar']) && $arg['bar'] instanceof Reference))->willReturn($typeLocatorDefinitionProphecy->reveal())->shouldBeCalled();
