...
class FilterPassTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $filterLocatorDefinitionProphecy->addArgument(Argument::that(static fn (array $arg): bool => !isset($arg['foo']) && isset($arg['my_id']) && $arg['my_id'] instanceof Reference))->willReturn($filterLocatorDefinitionProphecy->reveal())->shouldBeCalled();
    ...
    public function testIdNotExist(): void
    {
        ...
        $filterLocatorDefinitionProphecy = $this->prophesize(Definition::class);
        $filterLocatorDefinitionProphecy->addArgument(Argument::that(static fn (array $arg): bool => !isset($arg['foo']) && isset($arg['bar']) && $arg['bar'] instanceof Reference))->willReturn($filterLocatorDefinitionProphecy->reveal())->shouldBeCalled();
