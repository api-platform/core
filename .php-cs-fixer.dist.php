...
return (new PhpCsFixer\Config())
    ...
    ->setRules([
        ...
        'blank_line_before_statement' => ['statements' => ['return']], // @Symfony over  @PhpCsFixer
        ...
        'ordered_class_elements' => ['order' => ['use_trait']], // @Symfony over @PhpCsFixer
        ...
        'phpdoc_types_order' => ['null_adjustment' => 'always_last', 'sort_algorithm' => 'none'], // @Symfony over @PhpCsFixer
