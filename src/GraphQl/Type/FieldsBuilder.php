            ...
            foreach ($this->propertyNameCollectionFactory->create($resourceClass) as $property) {
                ...
                // TODO remove in 5.x
                    ...
                    foreach ($propertyTypes as $propertyType) {
                        if ($fieldConfiguration = $this->getResourceFieldConfiguration($property, $propertyMetadata->getDescription(), $propertyMetadata->getDeprecationReason(), PropertyInfoToTypeInfoHelper::convertLegacyTypesToType([$propertyType]), $resourceClass, $input, $operation, $depth, null !== $propertyMetadata->getSecurity())) {
                            $fields['id' === $property ? '_id' : $this->normalizePropertyName($property, $resourceClass)] = $fieldConfiguration;
