...
final class CollectionFiltersNormalizer implements NormalizerInterface, SerializerAwareInterface
{
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($format === self::FORMAT) {
            ...
            if ([] !== $currentFilters) {
                $data['search'] = $this->getSearch($resourceClass, $requestParts, $currentFilters);
            }
        }
    ...
    /**
     * Returns the content of the Swagger search property.
     *
    ...
    private function getSearch(string $resourceClass, array $parts, array $filters) : array
    {
        ...
        return [
            'filters' => sprintf('%s{?%s}', $parts['path'], implode(',', $variables)),
        ];
    }
}
