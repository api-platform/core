...
final class ItemPutOperationExtractor implements SwaggerOperationExtractorInterface
{
    ...
    public function extract(array $operationData): \ArrayObject
    {
        ...
        $documentation['summary'] = sprintf('Replaces the %s resource.', $resourceMetadata->getShortName());
        $documentation['parameters'] = [
            ...
            [
                ...
                'in' => 'body',
                'description' => sprintf('The updated %s resource', $resourceMetadata->getShortName()),
                'schema' => ['$ref' => sprintf('#/definitions/%s', $requestDefinitionKey)],
            ],
        ];
        $documentation['responses'] = [
            '200' => [
                'description' => sprintf('%s resource updated', $resourceMetadata->getShortName()),
    ...
    {
        return SwaggerOperationDataGuard::check($operationData) && 'PUT' === $operationData['method'] && !$operationData['isCollection'];
    }
}
