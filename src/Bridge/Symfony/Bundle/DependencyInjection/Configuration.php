        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('eager_loading')
                    ...
                    ->end()
                ->end()
                ->booleanNode('enable_fos_user')->defaultFalse()->info('Enable the FOSUserBundle integration.')->end()
                ->booleanNode('enable_nelmio_api_doc')->defaultFalse()->info('Enable the Nelmio Api doc integration.')->end()
                ->arrayNode('swagger')
                  ->canBeDisabled()
                  ->addDefaultsIfNotSet()
                  ->children()
                    ->booleanNode('enabled')->defaultTrue()->info('Enable the Swagger documentation and export.')->end()
                    ->booleanNode('ui_enabled')->defaultTrue()->info('Enable Swagger ui.')->end()
                    ->scalarNode('ui_path')->info('The Swagger ui path.')->end()
                  ->end()
                ->end()
