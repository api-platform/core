        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('eager_loading')
                    ...
                    ->end()
                ->end()
                ->arrayNode('doctrine_gedmo_extensions')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->booleanNode('from_header_enabled')->defaultFalse()->info('Enable the "From" header email address as a Gedmo Doctrine Extension Blameable user value.')->end()
                        ->arrayNode('from_header_unmatch')->prototype('scalar')->end()->info('Disable the "From" header on matched resources in documentation')->end()
                    ->end()
                ->end()
