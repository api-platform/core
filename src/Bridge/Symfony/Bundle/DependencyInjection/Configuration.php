        ...
        $rootNode
            ...
            ->children()
                ...
                ->booleanNode('enable_fos_user')
                    ...
                    ->setDeprecated(...$this->buildDeprecationArgs('2.5', 'FOSUser is not actively maintained anymore. Enabling the NelmioApiDocBundle integration has been deprecated in 2.5 and will be removed in 3.0.'))
