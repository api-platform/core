            ...
            ->children()
                ...
                ->arrayNode('oauth2')
                    ...
                    ->children()
                        ...
                        ->scalarNode('clientId')->defaultValue('')->info('The oauth2 client id.')->end()
                        ->scalarNode('clientSecret')->defaultValue('')->info('The oauth2 client secret.')->end()
                        ->scalarNode('type')->defaultValue('oauth2')->info('The oauth2 client secret.')->end()
                        ->scalarNode('flow')->defaultValue('application')->info('The oauth2 flow grant type.')->end()
                        ->scalarNode('tokenUrl')->defaultValue('/oauth/v2/token')->info('The oauth2 token url.')->end()
                        ->scalarNode('authorizationUrl')->defaultValue('/oauth/v2/auth')->info('The oauth2 authentication url.')->end()
                        ->arrayNode('scopes')
