                ...
                ->arrayNode('swagger')
                    ...
                    ->children()
                        ...
                        ->arrayNode('ui')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->enumNode('doc_expansion')
                                    ->info("Controls the default expansion setting for the operations and tags. It can be 'list' (expands only the tags), 'full' (expands the tags and operations) or 'none' (expands nothing).")
                                    ->values(['list', 'full', 'none'])
                                    ->defaultValue('list')
                                ->end()
                                ->booleanNode('filter')
                                    ->info('If set, enables filtering. The top bar will show an edit box that you can use to filter the tagged operations that are shown.')
                                    ->defaultFalse()
                                ->end()
                            ->end()
                        ->end()
