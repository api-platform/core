...
final class SwaggerCommand extends Command
{
    ...
    public function __construct(NormalizerInterface $normalizer, ResourceNameCollectionFactoryInterface $resourceNameCollection, string $apiTitle, string $apiDescription, string $apiVersion, array $apiContact, array $apiLicense, string $apiTermsOfService, array $apiFormats)
    {
