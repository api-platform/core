...
return static function (ContainerConfigurator $container) {
    $container->services()
        ->set('api_platform.swagger.normalizer.documentation', DocumentationNormalizer::class)
            ->args([ref('api_platform.metadata.resource.metadata_factory'), ref('api_platform.metadata.property.name_collection_factory'), ref('api_platform.metadata.property.metadata_factory'), ref('api_platform.json_schema.schema_factory'), ref('api_platform.json_schema.type_factory'), ref('api_platform.operation_path_resolver'), null, ref('api_platform.filter_locator'), null, param('api_platform.oauth.enabled'), param('api_platform.oauth.type'), param('api_platform.oauth.flow'), param('api_platform.oauth.tokenUrl'), param('api_platform.oauth.authorizationUrl'), param('api_platform.oauth.scopes'), param('api_platform.swagger.api_keys'), ref('api_platform.subresource_operation_factory'), param('api_platform.collection.pagination.enabled'), param('api_platform.collection.pagination.page_parameter_name'), param('api_platform.collection.pagination.client_items_per_page'), param('api_platform.collection.pagination.items_per_page_parameter_name'), param('api_platform.formats'), param('api_platform.collection.pagination.client_enabled'), param('api_platform.collection.pagination.enabled_parameter_name'), [], param('api_platform.swagger.versions')])
        ...
        ->set('api_platform.swagger.command.swagger_command', SwaggerCommand::class)
            ->args([ref('api_platform.serializer'), ref('api_platform.metadata.resource.name_collection_factory'), param('api_platform.title'), param('api_platform.description'), param('api_platform.version'), null, param('api_platform.swagger.versions')])
            ->tag('console.command');
};
