...
return static function (ContainerConfigurator $container) {
    $container->services()
        ...
        ->set('api_platform.doctrine.orm.order_filter', OrderFilter::class)
            ->args([service('doctrine'), 'null', param('api_platform.collection.order_parameter_name'), service('logger')->ignoreOnInvalid, "$nameConverter" => service('api_platform.name_converter')->ignoreOnInvalid, ])
        ...
        ->set('api_platform.doctrine.orm.exists_filter', ExistsFilter::class)
            ->args([service('doctrine'), 'null', service('logger')->ignoreOnInvalid, "$existsParameterName" => param('api_platform.collection.exists_parameter_name'), "$nameConverter" => service('api_platform.name_converter')->ignoreOnInvalid, ])
        ...
        ->set('api_platform.doctrine.orm.query_extension.eager_loading', EagerLoadingExtension::class)
            ->args([service('api_platform.metadata.property.name_collection_factory'), service('api_platform.metadata.property.metadata_factory'), service('api_platform.metadata.resource.metadata_factory'), param('api_platform.eager_loading.max_joins'), param('api_platform.eager_loading.force_eager'), 'null', 'null', param('api_platform.eager_loading.fetch_partial'), service('serializer.mapping.class_metadata_factory'), ])
        ...
        ->set('api_platform.doctrine.orm.query_extension.filter_eager_loading', FilterEagerLoadingExtension::class)
            ->args([service('api_platform.metadata.resource.metadata_factory'), param('api_platform.eager_loading.force_eager'), service('api_platform.resource_class_resolver'), ])
        ...
        ->set('api_platform.doctrine.orm.query_extension.order', OrderExtension::class)
            ->args([param('api_platform.collection.order'), service('api_platform.metadata.resource.metadata_factory'), ])
