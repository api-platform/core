...
return static function (ContainerConfigurator $container) {
    $container->services()
        ->set('api_platform.http_cache.listener.response.configure', AddHeadersListener::class)
            ->args(['%api_platform.http_cache.etag%', '%api_platform.http_cache.max_age%', '%api_platform.http_cache.shared_max_age%', '%api_platform.http_cache.vary%', '%api_platform.http_cache.public%', ref('api_platform.metadata.resource.metadata_factory')])
