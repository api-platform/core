...
return static function (ContainerConfigurator $container) {
    $container->services()
        ...
        ->set('api_platform.route_loader', ApiLoader::class)
            ->args([ref('kernel'), ref('api_platform.metadata.resource.name_collection_factory'), ref('api_platform.metadata.resource.metadata_factory'), ref('api_platform.operation_path_resolver.custom'), ref('service_container'), param('api_platform.formats'), param('api_platform.resource_class_directories'), ref('api_platform.subresource_operation_factory'), param('api_platform.graphql.enabled'), param('api_platform.enable_entrypoint'), param('api_platform.enable_docs'), param('api_platform.graphql.graphiql.enabled'), param('api_platform.graphql.graphql_playground.enabled')])
            ->tag('routing.loader')

        ->alias(UrlGeneratorInterface::class, 'api_platform.router')

        ->set('api_platform.router', Router::class)
            ->args([ref('router'), param('api_platform.url_generation_strategy')])
        ...
        ->set('api_platform.formats_provider', FormatsProvider::class)
            ->args([ref('api_platform.metadata.resource.metadata_factory'), param('api_platform.formats')])
        ...
        ->set('api_platform.listener.request.add_format', AddFormatListener::class)
            ->args([ref('api_platform.negotiator'), ref('api_platform.metadata.resource.metadata_factory'), param('api_platform.formats')])
        ...
        ->set('api_platform.listener.exception.validation', ValidationExceptionListener::class)
            ->args([ref('api_platform.serializer'), param('api_platform.error_formats')])
        ...
        ->set('api_platform.action.documentation', DocumentationAction::class)
            ->args([ref('api_platform.metadata.resource.name_collection_factory'), param('api_platform.title'), param('api_platform.description'), param('api_platform.version'), null, param('api_platform.swagger.versions')->nullOnInvalid()])
            ->public()

        ->set('api_platform.action.exception', ExceptionAction::class)
            ->args([ref('api_platform.serializer'), param('api_platform.error_formats'), param('api_platform.exception_to_status')])
            ->public()
