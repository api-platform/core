...
final class NotExposedOperationResourceMetadataCollectionFactory implements ResourceMetadataCollectionFactoryInterface
{
    ...
    public function create(string $resourceClass): ResourceMetadataCollection
    {
        ...
        [$key, $operation] = $this->getOperationWithDefaults($resource, new NotExposed(), generated: true, ignoredOptions: ['uriTemplate', 'uriVariables']); // @phpstan-ignore-line $resource is defined if count > 0
