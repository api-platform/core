...
class Operation
{
    ...
    public function getQueryParamterValidate(): bool
    {
        return $this->validate;
    }
    ...
    public function __serialize(): array
    {
        return [
            ...
            'security_message' => $this->securityMessage,
            'security_post_denormalize' => $this->securityPostDenormalize,
            'security_post_denormalize_message' => $this->securityPostDenormalizeMessage,
            'pagination_via_cursor' => $this->paginationViaCursor,
            'mercure' => $this->mercure,
            'query_parameter_validate' => $this->queryParameterValidate,
            'read' => $this->read,
            'write' => $this->write,
