...
abstract class Operation extends Metadata
{
    ...
    public function __construct(
        ...
        parent::__construct($shortName, $class, $description, $urlGenerationStrategy, $deprecationReason, $normalizationContext, $denormalizationContext, $collectDenormalizationErrors, $validationContext, $filters, $elasticsearch, $mercure, $messenger, $input, $output, $order, $fetchPartial, $forceEager, $paginationEnabled, $paginationType, $paginationItemsPerPage, $paginationMaximumItemsPerPage, $paginationPartial, $paginationClientEnabled, $paginationClientItemsPerPage, $paginationClientPartial, $paginationFetchJoinCollection, $paginationUseOutputWalkers, $security, $securityMessage, $securityPostDenormalize, $securityPostDenormalizeMessage, $securityPostValidation, $securityPostValidationMessage, $provider, $processor, $stateOptions, $extraProperties);
    }
