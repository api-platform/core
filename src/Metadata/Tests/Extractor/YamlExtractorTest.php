...
class YamlExtractorTest extends TestCase
{
    ...
    public function testOpenApiParameters(): void
    {
        ...
        $this->assertSame('author', $operation->getParameters()[0]->getName());
        $this->assertSame('path', $operation->getParameters()[0]->getIn());
        $this->assertSame('john-doe', $operation->getParameters()[0]->getExample());
    }
