...
if (interface_exists(\ApiPlatform\Api\UrlGeneratorInterface::class)) {
    class_alias(
        \ApiPlatform\Api\UrlGeneratorInterface::class,
        __NAMESPACE__.'\UrlGeneratorInterface'
    );

    if (false) { // @phpstan-ignore-line
        interface UrlGeneratorInterface extends \ApiPlatform\Api\UrlGeneratorInterface
        {
        }
    }
} else {
