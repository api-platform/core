...
class TypeFactoryTest extends TestCase
{
    ...
    public static function typeProvider(): iterable
    {
        ...
        yield [['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, Dummy::class)];
        yield [['nullable' => true, 'type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, true, Dummy::class)];
        ...
        yield ['enum resource' => ['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, GamePlayMode::class)];
        yield ['nullable enum resource' => ['type' => 'string', 'format' => 'iri-reference', 'example' => 'string', 'nullable' => true], new Type(Type::BUILTIN_TYPE_OBJECT, true, GamePlayMode::class)];
    ...
    public static function jsonSchemaTypeProvider(): iterable
    {
        ...
        yield [['type' => 'string', 'format' => 'binary'], new Type(Type::BUILTIN_TYPE_OBJECT, false, \SplFileInfo::class)];
        yield [['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, Dummy::class)];
        yield [['type' => ['string', 'null'], 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, true, Dummy::class)];
        yield ['enum' => ['type' => 'string', 'enum' => ['male', 'female']], new Type(Type::BUILTIN_TYPE_OBJECT, false, GenderTypeEnum::class)];
        yield ['nullable enum' => ['type' => ['string', 'null'], 'enum' => ['male', 'female', null]], new Type(Type::BUILTIN_TYPE_OBJECT, true, GenderTypeEnum::class)];
        yield ['enum resource' => ['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, GamePlayMode::class)];
        yield ['nullable enum resource' => ['type' => ['string', 'null'], 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, true, GamePlayMode::class)];
        yield [['type' => 'array', 'items' => ['type' => 'string']], new Type(Type::BUILTIN_TYPE_STRING, false, null, true)];
        yield 'array can be itself nullable' => [
    ...
    public static function openAPIV2TypeProvider(): iterable
    {
        ...
        yield [['type' => 'string', 'format' => 'binary'], new Type(Type::BUILTIN_TYPE_OBJECT, false, \SplFileInfo::class)];
        yield [['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, Dummy::class)];
        yield [['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, true, Dummy::class)];
        yield ['enum' => ['type' => 'string', 'enum' => ['male', 'female']], new Type(Type::BUILTIN_TYPE_OBJECT, false, GenderTypeEnum::class)];
        yield ['nullable enum' => ['type' => 'string', 'enum' => ['male', 'female', null]], new Type(Type::BUILTIN_TYPE_OBJECT, true, GenderTypeEnum::class)];
        yield ['enum resource' => ['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, false, GamePlayMode::class)];
        yield ['nullable enum resource' => ['type' => 'string', 'format' => 'iri-reference', 'example' => 'string'], new Type(Type::BUILTIN_TYPE_OBJECT, true, GamePlayMode::class)];
        yield [['type' => 'array', 'items' => ['type' => 'string']], new Type(Type::BUILTIN_TYPE_STRING, false, null, true)];
