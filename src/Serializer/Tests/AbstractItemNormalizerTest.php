...
class AbstractItemNormalizerTest extends TestCase
{
    ...
    public function testNormalizePolymorphicFictionBook(): void
    {
        ...
        $propertyNameCollectionFactoryProphecy->create(Book::class, Argument::type('array'))->willReturn(new PropertyNameCollection(['title', 'author', 'isbn', 'bookType']));
        $propertyMetadataFactoryProphecy->create(Book::class, 'title', Argument::type('array'))->willReturn((new ApiProperty())->withNativeType(Type::string())->withReadable(true)->withWritable(true));
        $propertyMetadataFactoryProphecy->create(Book::class, 'author', Argument::type('array'))->willReturn((new ApiProperty())->withNativeType(Type::object(Author::class))->withReadable(true)->withWritable(true));
        $propertyMetadataFactoryProphecy->create(Book::class, 'isbn', Argument::type('array'))->willReturn((new ApiProperty())->withNativeType(Type::string())->withReadable(true)->withWritable(true));
        $propertyMetadataFactoryProphecy->create(Book::class, 'bookType', Argument::type('array'))->willReturn((new ApiProperty())->withNativeType(Type::string())->withReadable(true)->withWritable(false));
