...
class IriConverter implements IriConverterInterface
{
    ...
    public function getIriFromResource(object|string $resource, int $referenceType = UrlGeneratorInterface::ABS_PATH, ?Operation $operation = null, array $context = []): ?string
    {
        ...
        if (!isset($context['item_uri_template']) && $operation instanceof HttpOperation && !$operation instanceof CollectionOperationInterface && null !== ($canonicalUriTemplate = $operation->getCanonicalUriTemplate()) && $canonicalUriTemplate !== $operation->getUriTemplate()) {
