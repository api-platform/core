...
use ApiPlatform\JsonApi\Serializer\CollectionNormalizer as DecoratedCollectionNormalizer;
...
/**
 * Normalizes collections in the Toon JSON:API format through composition.
 */
final class ToonJsonApiCollectionNormalizer implements NormalizerInterface, SerializerAwareInterface
{
