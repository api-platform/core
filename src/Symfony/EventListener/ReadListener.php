...
final class ReadListener
{
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        if (!$operation || !$operation->canRead() || !$attributes['receive'] || (!$operation->getUriVariables() && !$request->isMethodSafe()) || ($operation->getExtraProperties()['is_legacy_resource_metadata'] ?? false) || ($operation->getExtraProperties()['is_legacy_subresource'] ?? false)) {
            return;
        }
