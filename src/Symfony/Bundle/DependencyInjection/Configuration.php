        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('validator')
                    ...
                    ->children()
                        ...
                        ->booleanNode('query_parameter_validation')
                            ->defaultValue(true)
                            ->setDeprecated('api-platform/symfony', '4.2', 'The "query_parameter_validation" configuration is deprecated and will be removed in API Platform 5.0.')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('jsonapi')
                ...
                ->booleanNode('enable_link_security')
                    ...
                    ->setDeprecated('api-platform/symfony', '4.2', 'The "enable_link_security" configuration is deprecated, this option is always enabled and will be removed in API Platform 5.0.')
                ->end()
