...
use ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeItem;
use ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeLabel;
use ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeRelation;
use ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar;
use ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyTravel;
...
class FilterEagerLoadingExtensionTest extends TestCase
{
    ...
    public function testApplyCollection(): void
    {
        ...
        $this->assertSame('SELECT o FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar o LEFT JOIN o.colors colors WHERE o IN(SELECT o_2 FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar o_2 LEFT JOIN o_2.colors colors_2 WHERE o_2.colors = :foo)', $qb->getDQL());
    }
    ...
    public function testApplyCollectionWithManualJoin(): void
    {
        ...
        $expected = <<<'SQL'
SELECT o
FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar o
LEFT JOIN o.colors colors
INNER JOIN ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyTravel t_a3 WITH o.id = t_a3.car AND t_a3.passenger = :user
WHERE o IN(
  SELECT o_2 FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar o_2
  LEFT JOIN o_2.colors colors_2
  INNER JOIN ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyTravel t_a3_a20 WITH o_2.id = t_a3_a20.car AND t_a3_a20.passenger = :user
...
SQL;
    ...
    public function testCompositeIdentifiers(): void
    {
        ...
        $expected = <<<SQL
SELECT o
FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeRelation o
INNER JOIN o.compositeItem item
INNER JOIN o.compositeLabel label
WHERE o.item IN(
    SELECT IDENTITY(o_2.item) FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeRelation o_2
    INNER JOIN o_2.compositeItem item_2
    INNER JOIN o_2.compositeLabel label_2
    WHERE item_2.field1 = :foo
) AND o.label IN(
    SELECT IDENTITY(o_2.label) FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeRelation o_2
    INNER JOIN o_2.compositeItem item_2
    INNER JOIN o_2.compositeLabel label_2
    WHERE item_2.field1 = :foo
)
...
LEFT JOIN ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar car WITH car.id = o.car
WHERE o.item IN(
    SELECT IDENTITY(o_2.item) FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\CompositeRelation o_2
    INNER JOIN o_2.compositeItem item_2
    INNER JOIN o_2.compositeLabel label_2
...
LEFT JOIN o.colors colors
WHERE o.id IN(
  SELECT IDENTITY(o_2.id) FROM ApiPlatform\Doctrine\Orm\Tests\Fixtures\TestBundle\Entity\DummyCar o_2
  LEFT JOIN o_2.colors colors_2
  WHERE o_2.colors = :foo
)
SQL;
