...
use ApiPlatform\Doctrine\Odm\Tests\Fixtures\TestBundle\Document\ProviderEntity;
...
class ItemProviderTest extends TestCase
{
    ...
    public function testCannotCreateAggregationBuilder(): void
    {
        ...
        $this->expectExceptionMessage('The repository for "ApiPlatform\Doctrine\Odm\Tests\Fixtures\TestBundle\Document\ProviderEntity" must be an instance of "Doctrine\ODM\MongoDB\Repository\DocumentRepository".');
